...
- 로컬 TTS를 한 번 준비하면 200문항 녹음본을 한 번에 미리 만들거나 필요한 문항만 자동 생성 가능
...
- **녹음본**: Kokoro가 만든 질문 WAV를 IndexedDB에 캐시해 다음부터 파일처럼 재생. **200문항 녹음본 미리 만들기**를 누르면 한 번에 준비하고, 누르지 않으면 필요한 문항을 첫 재생 때 자동 생성
